...
def go():
    ...
    if result: 
        ...
        if len(flagCen) == 2:
            ...
            cv2.putText(redim, f"L: {angle}d", (30, 20), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (255,0, 20), 2)
            ...
            angle -= 225
            angle = fixAngle(angle)
            cv2.putText(redim, f"R: {angle}d", (30, 50), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (255, 255, 20), 2)
